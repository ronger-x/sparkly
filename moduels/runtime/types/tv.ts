...
type ComponentAppConfig<
  ...
  K extends string,
  U extends string = 'ui' | 'rymcu' | 'rymcu.prose'
> = A & (
  U extends 'rymcu.prose'
    ? { rymcu?: { prose?: { [k in K]?: Partial<T> } } }
    : { [key in Exclude<U, 'rymcu.prose'>]?: { [k in K]?: Partial<T> } }
)
 ...
 * @template U The top-level key in AppConfig ('ui' or 'rymcu').
 */
export type ComponentConfig<
  T extends Record<string, any>,
  A extends Record<string, any>,
  K extends string,
  U extends 'ui' | 'rymcu' | 'rymcu.prose' = 'ui'
> = {
