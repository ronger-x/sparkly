...
async function onSubmit(event: FormSubmitEvent<Schema>) {
  toast.add({ title: 'Success', description: `Edit dict ${event.data.label} added`, color: 'success' })
  open.value = false
}
</script>

<template>
  <UModal v-model:open="open" title="Edit dict" description="Updat dict info">
    <UButton label="Edit dict" icon="i-lucide-plus" />
